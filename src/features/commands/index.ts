...
export const PALETTE_COMMANDS = [
  ...
  { id: 'zap-ads', label: 'Zap Ads' },
  { id: 'wayback', label: 'Wayback Machine' },
  { id: 'qr-page', label: 'QR This Page' },
  { id: 'close-duplicate-tabs', label: 'Close Duplicate Tabs' },
  { id: 'new-folder', label: 'New Bookmark Folder…' },
  { id: 'bookmark-tab', label: 'Bookmark Current Tab' },
  { id: 'create-quicklink', label: 'Create Quicklink' },
  { id: 'save-page-quicklink', label: 'Save Page as Quicklink' },
  { id: 'view-quicklinks', label: 'Quicklinks' },
...
export const COMMAND_META: Record<string, { icon: string; color: string }> = {
  ...
  screenshot: { icon: 'camera', color: '#3ab5c6' },
  'speed-test': { icon: 'gauge', color: '#3ab5c6' },
  'zap-ads': { icon: 'bolt', color: '#e05d5d' },
  wayback: { icon: 'archive', color: '#e8964a' },
  'qr-page': { icon: 'chart', color: '#7d8a97' },
  'close-duplicate-tabs': { icon: 'tab', color: '#e05d5d' },
  'new-folder': { icon: 'folder', color: '#3f97ee' },
  'bookmark-tab': { icon: 'bookmark', color: '#e05d5d' },
  'create-quicklink': { icon: 'link', color: '#e8964a' },
  'save-page-quicklink': { icon: 'link', color: '#e8964a' },
  'view-quicklinks': { icon: 'link', color: '#e8964a' },
